        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 create-franchisee">
            ...
            <form role="form" class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control datepicker date" data-date data-date-format="dd.mm.yyyy" data-picker-position="bottom-right">
                </div>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 phone">
                    <div class="input-group">
                        <input type="text" class="form-control">
                        <span class="input-group-btn">
                            <button class="btn btn-link" type="button">&minus;&nbsp;Удалить телефон</button>
                        </span>
                    </div>
                </div>
                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table">
                ...
                <tr>
                    <td class="col-lg-4 col-md-4 col-sm-3 col-xs-4">
                        <div class="media">
